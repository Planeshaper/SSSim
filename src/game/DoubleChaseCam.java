 ...
 * @author nehon
 */
public class DoubleChaseCam implements ActionListener, AnalogListener, Control, JmeCloneable {
     ...
     */
    public DoubleChaseCam(Camera cam, final Spatial target) {
        this(cam);
     ...
     * @param cam the application camera
     */
    public DoubleChaseCam(Camera cam) {
        this.cam = cam;
     ...
     */
    public DoubleChaseCam(Camera cam, InputManager inputManager) {
        this(cam);
     ...
     * @param inputManager the inputManager of the application to register inputs
     */
    public DoubleChaseCam(Camera cam, final Spatial target, InputManager inputManager) {
        this(cam, target);
        registerWithInput(inputManager);
    }
    ...
    */
    ...
    protected void computeYAnchoredPosition() {
        
        rotation = -target.getLocalRotation().toAngles(null)[1];
        float hDistance = (distance) * FastMath.sin((FastMath.PI / 2) - vRotation);
        pos.set(hDistance * FastMath.cos(rotation), (distance) * FastMath.sin(vRotation), hDistance * FastMath.sin(rotation));
        pos.addLocal(target.getWorldTranslation());
    }
    ...
    protected void updateCamera(float tpf) {
        if (enabled) {
            ...
            if (smoothMotion) {
                ...
                computePosition();
                //computeYAnchoredPosition();
                cam.setLocation(pos.addLocal(lookAtOffset));
//                System.out.println("Pre: " + cam.getRotation().getW() + ", " + 
//                        cam.getRotation().getX() + ", " + 
//                        cam.getRotation().getY() + ", " + 
//                        cam.getRotation().getZ());
//                //cam.setRotation(target.getWorldRotation());
//                System.out.println("Set: " + cam.getRotation().getW() + ", " + 
//                        cam.getRotation().getX() + ", " + 
//                        cam.getRotation().getY() + ", " + 
//                        cam.getRotation().getZ());
//                System.out.println("World: " + target.getWorldRotation().getW() + ", " + 
//                        target.getWorldRotation().getX() + ", " + 
//                        target.getWorldRotation().getY() + ", " + 
//                        target.getWorldRotation().getZ() + ", Local: " + 
//                        target.getWorldRotation().getW() + ", " + 
//                        target.getWorldRotation().getX() + ", " + 
//                        target.getWorldRotation().getY() + ", " + 
//                        target.getWorldRotation().getZ());
            }
...
//            System.out.println("Look At: " + cam.getRotation().getW() + ", " + 
//                    cam.getRotation().getX() + ", " + 
//                    cam.getRotation().getY() + ", " + 
//                    cam.getRotation().getZ());
    ...
    public Control cloneForSpatial(Spatial spatial) {
        DoubleChaseCam cc = new DoubleChaseCam(cam, spatial, inputManager);
    ...
    public Object jmeClone() {
        DoubleChaseCam cc = new DoubleChaseCam(cam, inputManager);
        cc.target = target;
        cc.setMaxDistance(getMaxDistance());
        cc.setMinDistance(getMinDistance());
        return cc;
